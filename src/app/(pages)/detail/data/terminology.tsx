export const terminology = [
  ...
  },
  {
    ...
    description:
      'Measures a tire\'s resistance to heat generation and its ability to dissipate heat. Rated from highest to lowest as A, B, or C. An "A" rating indicates the best heat resistance, which is important for high-speed driving and hot weather conditions.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    title: 'Speed rating',
    description:
      'A letter that indicates the maximum speed capability of a tire under optimal conditions. Ratings range from L (75 mph) to Y (186+ mph). Choosing the right speed rating ensures your tires can safely handle your driving needs.',
  },
  {
    id: 6,
    title: 'Tire pressure',
