...
const BrandHeadline: FC<BrandHeadlineProps> = ({ as: Tag = 'h1', size = 'lg', className }) => {
  const mainClass =
    size === 'lg'
      ...
      : 'text-xl sm:text-2xl uppercase font-extrabold text-white tracking-tight [text-shadow:_0px_4px_4px_rgb(0_0_0_/_0.45)]';

  const subClass =
    size === 'lg'
      ? 'text-2xl sm:text-3xl font-semibold sm:font-bold uppercase text-white tracking-tight'
      : 'text-lg sm:text-xl font-semibold uppercase text-white tracking-tight';
