...
function MobileTopFilters({ children }: { children: React.ReactElement }) {
    ...
    <Menu as="div" className="relative inline-block text-left w-full">
      <div className="flex items-center justify-between rounded-xl ring-1 ring-gray-300 p-2 px-2">
        ...
        <MenuButton
          ...
          className="flex items-center rounded-full bg-greenPrimary text-white focus:outline-none focus:ring-offset-greenPrimary"
        >
